 ...
 */
class APCUserCache implements CacheInterface
{
    /**
    ...
    public function set($key, $value, $ttl = null)
    {
        ...
        if ($ttl !== null && !($ttl instanceof \DateInterval) && !is_int($ttl)) {
            throw new InvalidArgumentException();
        }
    ...
    public function getMultiple($keys, $default = null)
    {
        ...
        $keyValue = [];
        foreach ($keys as $key) {
            $keyValue[$key] = $this->get($key, $default);
        }
    ...
    public function setMultiple($values, $ttl = null)
    {
        ...
        if (count(array_filter($values, 'is_string', ARRAY_FILTER_USE_KEY)) !== count($values)) {
            throw new InvalidArgumentException();
        }
